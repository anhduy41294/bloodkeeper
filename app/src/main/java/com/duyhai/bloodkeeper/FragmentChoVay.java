 ...
 */
public class FragmentChoVay extends Fragment {
    ...
    public void showDialog(final int index) {
        ...
        b.setNeutralButton("Nhận tiền", new DialogInterface.OnClickListener() {
            @Override
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 3) //intent them tong tien
        {
            switch (resultCode) {
                case 1:
    ...
    public List<VayNoDetail> getData() {
        ...
        List<VayNoItem> lst = VayNodb.getAllChoVay();
