...
public class MainActivity extends ActionBarActivity {
    ...
    private HuTienItemAdapter adapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_timkiem) {
            startActivity(new Intent(MainActivity.this, TimKiemNangCaoActivity.class));
            return true;
        }
    ...
    public void onResume() {
        super.onResume();
        adapter = new HuTienItemAdapter(MainActivity.this,getData());
    ...
    public void getFormWidget() {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.drawerListHuTien);
        adapter = new HuTienItemAdapter(MainActivity.this, getData());
        recyclerView.setAdapter(adapter);
        ...
        actionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent themtongtien = new Intent(MainActivity.this, ThemTongTien.class);
                startActivityForResult(themtongtien, 1);
                if(TongTien != 0 ) actionButton.detach();
            }
        });
    ...
    public void goGDTheoHu(int i) {
        Intent itn = new Intent(MainActivity.this, GiaoDichTrongHuTien.class);
